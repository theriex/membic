...
set filenames to {"MORKeywords.scpt", "MORUpdate.scpt", "MORUtil.scpt", "MORSetup.scpt", "morLinifyRecord.py", "FGFwebExport.scpt", "FGFwebList.scpt", "FGFwebPlaylist.scpt", "FGFwebReview.scpt"}
repeat with fname in filenames
	set cfile to (quoted form of (itsdir & fname))
	set command to "rm -f " & cfile
	do shell script command
end repeat
display dialog "FGFweb script files removed"
